...
public class EntradaDados{
    public static void executar(Scanner sc) {
        ...
        System.out.println("Informe em sequencia duas palavra e um numero inteiro");
        x = sc.next();
        y = sc.next();
        z = sc.nextInt();
        System.out.printf("%s, %s, %d%n", x, y, z);
        //Recebendo uma linha inteira
        //sc.nextLine() deve ser chamado para "limpar" resquícios de chamadas diferentes de sc.Line()
        sc.nextLine();
